...
DB_NAME = 'gacha_v40.db' # Снова меняем имя базы, чтобы гарантировать полную пересоздание и чистоту

PETS_DATA = [
    # Ивентовые (is_event 1 для Феникса, 2 для Цербера)
    ("Феникс", "Красное", "assets/pets/phoenix.png", 1, "Возрождение"), 
    ("Цербер", "Красное", "assets/pets/cerberus.png", 2, "Многоголовость"), # <--- Убедись, что здесь запятая
    # Стандартные красные (is_event 0, для проигрыша 50/50)
    ("Единорог", "Красное", "assets/pets/unicorn.png", 0, "Чистота"), 
    ("Дракон", "Красное", "assets/pets/dragon.png", 0, "Огненное дыхание"),
    # Обычные редкости
    ("Собака", "Фиолетовое", "assets/pets/dog.png", 0, "Преданность"),
    ("Кошка", "Фиолетовое", "assets/pets/cat.png", 0, "Независимость"),
    ("Божья коровка", "Фиолетовое", "assets/pets/ladybug.png", 0, "Удача"),
    ("Мышь", "Синее", "assets/pets/mouse.png", 0, "Ловкость"),
    ("Хомяк", "Синее", "assets/pets/hamster.png", 0, "Запасливость"),
    ("Кролик", "Голубое", "assets/pets/bunny.png", 0, "Скорость"),
    ("Улитка", "Голубое", "assets/pets/snail.png", 0, "Терпение"),
    ("Пчела", "Голубое", "assets/pets/bee.png", 0, "Трудолюбие"),
    ("Черепаха", "Зеленое", "assets/pets/turtle.png", 0, "Долголетие"),
    ("Слон", "Зеленое", "assets/pets/elephant.png", 0, "Мудрость"),
    ("Медведь", "Зеленое", "assets/pets/bear.png", 0, "Сила"),
    ("Змея", "Желтое", "assets/pets/snake.png", 0, "Гибкость"),
    ("Попугай", "Желтое", "assets/pets/parrot.png", 0, "Повторение"),
    ("Жираф", "Желтое", "assets/pets/giraffe.png", 0, "Высота"),
    ("Летучая мышь", "Оранжевое", "assets/pets/bat.png", 0, "Ночной полет"),
    ("Акула", "Оранжевое", "assets/pets/shark.png", 0, "Острые зубы"),
    ("Паук", "Оранжевое", "assets/pets/spider.png", 0, "Паутина"),
]
